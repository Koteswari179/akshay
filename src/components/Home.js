      ...
      <section id="about">
        ...
        <div className='about-container'>
          <div className='about-left-side'>
            ...
            <p><i className="ri-check-double-line"></i> We started with a simple idea: do what is best for the client.</p>
            <p><i className="ri-check-double-line"></i> Our methodical and individual approach to each project delivers the finest possible results for your media.</p>
            <p><i className="ri-check-double-line"></i> Our day-to-day work is to solve your problems utilizing the most up-to-date, practical adaptive technology, and we have a lot of fun doing it.</p>
          </div>
        ...
        <div className="section-about">
          ...
          <div className="count-box-container">
            <div className="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="3835039" data-purecounter-duration="2" className="purecounter" data-purecounter-id="organic-reach"></span>
              <p><strong>Organic Reach</strong> (Global)</p>
            </div>
            <div className="count-box">
              <i className="bi bi-clock"></i>
              <span data-purecounter-start="0" data-purecounter-end="14081" data-purecounter-duration="2" className="purecounter" data-purecounter-id="watch-hours"></span>
          ...
          <div className="count-box-container">
            <div className="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="85" data-purecounter-duration="3" className="purecounter" >85</span>
              <p><strong>campaigns</strong></p>
            </div>
            <div className="count-box">
              <i className="bi bi-globe"></i>
              <span data-purecounter-start="0" data-purecounter-end="17" data-purecounter-duration="1" className="purecounter">17</span>
      ...
      <section className='features'>
        ...
        <div className='features-container'>
          ...
          <div className="features-box">
            ...
            <h4><a href="">Media buying</a></h4>
          </div>
          <div className="features-box">
            <i className="ri-search-eye-line"></i>
            <h4><a href="">Search engine</a></h4>
          </div>
          <div className="features-box">
            <i className="ri-todo-line"></i>
            <h4><a href="">Brand strategy</a></h4>
          </div>
          <div className="features-box">
            <i className="ri-map-pin-line"></i>
            <h4><a href="">Local search marketing</a></h4>
          </div>
          <div className="features-box">
            <i className="ri-bar-chart-grouped-line"></i>
            <h4><a href="">Lead Tracking & Management</a></h4>
          </div>
          <div className="features-box">
          ...
          <div className="features-box">
            ...
            <h4><a href="">Media management</a></h4>
          </div>
          <div className="features-box">
            <i className="ri-calendar-event-line"></i>
            <h4><a href="">Social scheduling</a></h4>
          </div>
          <div className="features-box">
            <i className="ri-advertisement-fill"></i>
            <h4><a href="">Ad retargeting</a></h4>
          </div>
        </div>
      </section>
